        ...
        <section className="min-h-screen relative bg-center bg-cover flex items-center justify-center" style={{backgroundImage:`url(${bgImage})`}}>
            ...
            <div className="relative z-10 max-w-4xl text-center px-6">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    {isLoggedIn && (
                        <Link to="/profile" className="inline-block rounded-md px-6 py-3 font-semibold text-white border-2 border-[#f7b731] hover:bg-[#f7b731] hover:text-black transition" aria-label="Create Profile">Create Profile</Link>
                    )}
                </div>
            </div>
        </section>
